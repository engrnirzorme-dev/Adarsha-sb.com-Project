...
<html lang="en">
    ...
    <head>
        ...
        <title>বিষয় ভিত্তিক পরীক্ষার ফলাফল - <?= toBangla(date("2024")) ?></title>
                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td colspan="3" style="background: #25B7EF"><strong>প্রথম প্রান্তিক মূল্যায়ন</strong></td>
                            <td colspan="3" style="background: #25B7EF"><strong>দ্বিতীয় প্রান্তিক মূল্যায়ন</strong></td>
