        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <nav class="navbar navbar-static-top">
                    ...
                    <h3 style="display: inline-block;margin-top: 10px;"><a href="" style="color: white;"><?= $this->config->item('institute_name')." - ".to_bangla(date("2024")) ?></a></h3>
            ...
            <footer class="main-footer">
                ...
                <strong>&copy;  <?= to_bangla(date("2024")) ?> রেজাল্ট ম্যানেজমেন্ট সফটওয়্যার। </strong> <!-- Developed by <a href="http://cdaitsolution.net" data-widget="remove" data-toggle="tooltip" title="cdaitsolution">CDA IT Solution</a>.</strong> -->
            </footer>
        </div>
