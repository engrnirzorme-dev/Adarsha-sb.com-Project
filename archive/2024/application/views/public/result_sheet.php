...
<html lang="en">
    ...
    <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <title>বিষয় ভিত্তিক পরীক্ষার ফলাফল - <?= date("2024") ?></title>
    ...
    <body onload="window.print()">
        <?php
            ...
            $result = json_decode($student['result'], TRUE);
		?>
            <div class="marksheet">
                <div class="head">
                    <div class="logo">
                    ...
                    <div class="title">
                        ...
                        <h3>বিষয় ভিত্তিক পরীক্ষার ফলাফল - <?= to_bangla(date("2024")) ?></h3>
                    </div>
                    <table>
                        <tr>
                            <td>Letter Grade</td>
                ...
                <table class="student-info" style="width: 100%; margin: 7px 0">
                    <tr>
                        <td>ছাত্র/ছাত্রীর নাম : <b><?= $student['name_bn'] ?></b></td>
                        <td>শ্রেণী : <b><?= allclass($student['class']) ?></b></td>
                        <td>শাখা : <b><?= section($student['section']) ?></b></td>
                        <td>রোল নং : <b><?= to_bangla($student['class_roll']) ?></b></td>
                        <td>প্রাপ্ত পয়েন্ট/গ্রেড : <b><?= $show_4 ? toBangla($student['gpa']).'/'.gla($student['gpa']) : '' ?></b></td>
                    </tr>
                </table>
                <table>
                    <tbody>
                        <tr>
                            <td rowspan="2"><div class="rotate">বিষয়</div></td>
                            <td rowspan="2" style="width: 132px">মান বন্টন</td>
                            <td colspan="3"> প্রথম প্রান্তিক মূল্যায়ন  </td>
                            <td colspan="3"> দ্বিতীয় প্রান্তিক মূল্যায়ন  </td>
                            <td colspan="3"> চূড়ান্ত মূল্যায়ন </td>
                            <td rowspan="2">প্রাপ্ত নম্বরের ১০০%</td>
                            <td rowspan="2" colspan="2">প্রাপ্ত গ্রেড</td>
                        </tr>
                        <tr>
                            <td>সর্বোচ্চ নম্বর</td>
                            <td>প্রাপ্ত নম্বর</td>
                            <td>প্রাপ্ত নম্বরের ২০%</td>
                            <td>সর্বোচ্চ নম্বর</td>
                            <td>প্রাপ্ত নম্বর</td>
                            <td>প্রাপ্ত নম্বরের ৩০%</td>
                            <td>সর্বোচ্চ নম্বর</td>
                            <td>প্রাপ্ত নম্বর</td>
                            <td>প্রাপ্ত নম্বরের ৫০%</td>
                        </tr> 
                        <?php
                        foreach (explode(",", $student['subject']) as $sub_code) {
                            ...
                            foreach (mark_type() as $type_id => $type_name) {
                                ...
                                <tr class="<?= $subrow['full_' . $type_id] > 0 ? '' : 'hiderow' ?>">
                                    <?php if ($type_id == 1) { ?>
                                        <td rowspan="4"><div class="rotate"><?= $subrow['name'] ?></div></td>
                                    <?php } ?>
                                    ...
                                    <td><?= toBangla($show_4 ? isset($result[$sub_code][$type_id][100]) ? $result[$sub_code][$type_id][100] : '' : '') ?></td>
                                    <td></td> 
                                    <td></td>
                                </tr>
                                <?php
                            ...
                            <tr style=" background: #fafafa">
                                ...
                                <td><b><?= toBangla($show_4 ? isset($result[$sub_code][4][100]) ? $result[$sub_code][4][100] : '' : '') ?></b></td>
                        ...
                        <tr>
                            <td></td>
                            <td>সর্বমোট - <?= toBangla($result[5][0]) ?></td>
                            <td></td>
                            <td><b><?= toBangla(isset($post['exam'][1]) ? isset($result[1][5][1]) ? $result[1][5][1] : '' : '') ?></b></td>
                            <td><b><?= toBangla(isset($post['exam'][1]) ? isset($result[1][5][4]) ? $result[1][5][4] : '' : '') ?></b></td>
                            <td></td>
                            <td><b><?= toBangla(isset($post['exam'][2]) ? isset($result[2][5][1]) ? $result[2][5][1] : '' : '') ?></b></td>
                            <td><b><?= toBangla(isset($post['exam'][2]) ? isset($result[2][5][4]) ? $result[2][5][4] : '' : '') ?></b></td>
                            <td></td>
                            <td><b><?= toBangla(isset($post['exam'][3]) ? isset($result[3][5][1]) ? $result[3][5][1] : '' : '') ?></b></td>
                            <td><b><?= toBangla(isset($post['exam'][3]) ? isset($result[3][5][4]) ? $result[3][5][4] : '' : '') ?></b></td>
                            <td><b><?= toBangla($show_4 ? isset($result[5][100]) ? $result[5][100] : '' : '') ?></b></td>
                            <td></td>
                            <td></td>
                        </tr>
                    </tbody>
                ...
                <div class="signature">
                    ...
                    <div class="right">অধ্যক্ষের স্বাক্ষর</div>
                </div>
            </div>
    </body>
