        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <nav class="navbar navbar-static-top">
                    ...
                    <h3 style="display: inline-block;margin-top: 10px;"><a href="" style="color: white;"><?= $this->config->item('institute_name')." - ".to_bangla(date("2025")) ?></a></h3>
            ...
            <footer class="main-footer">
                ...
                <strong>&copy;  <?= to_bangla(date("2025")) ?> রেজাল্ট ম্যানেজমেন্ট সফটওয়্যার। </strong> <!-- Developed by <a href="http://smart-softit.com" data-widget="remove" data-toggle="tooltip" title="Smart Soft IT || 01756-965235">Smart Soft IT</a>.</strong> -->
            </footer>
        </div>
