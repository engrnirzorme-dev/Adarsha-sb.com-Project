<div class="box box-info">
    <div class="box-header with-border">
        <h3 class="box-title">Student Add Form</h3>
		...
		<form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="name_bn" name="name_bn" placeholder="ছাত্র/ছাত্রীর নাম" value="<?= set_value('name_bn') ?>" required >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="name_en" name="name_en" placeholder="Name of the student" value="<?= set_value('name_en') ?>" style="text-transform: uppercase" onChange="checkInputText(this)" onKeyup="checkInputText(this)">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="father_bn" name="father_bn" placeholder="পিতার নাম" value="<?= set_value('father_bn') ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="father_en" name="father_en" placeholder="Father Name" value="<?= set_value('father_en') ?>" style="text-transform: uppercase" onChange="checkInputText(this)" onKeyup="checkInputText(this)">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="mother_bn" name="mother_bn" placeholder="মাতার নাম" value="<?= set_value('mother_bn') ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="mother_en" name="mother_en" placeholder="Mother Name" value="<?= set_value('mother_en') ?>" style="text-transform: uppercase" onChange="checkInputText(this)" onKeyup="checkInputText(this)">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="class_roll" name="class_roll" placeholder="ক্লাস রোল" value="<?= set_value('class_roll') ?>" required  onChange="checkInput(this)" onKeyup="checkInput(this)">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="permanent_village" name="permanent_village" placeholder="গ্রাম/মহল্লা" value="<?= set_value('permanent_village') ?>">
                        <?= form_error('permanent_village', '<div class="text-danger">', '</div>'); ?>
                    </div>
                    <label for="permanent_post" class="col-sm-2 control-label">ডাকঘর  </label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="permanent_post" name="permanent_post" placeholder="ডাকঘর" value="<?= set_value('permanent_post') ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="permanent_upazila" name="permanent_upazila" placeholder="উপজেলা" value="<?= set_value('permanent_upazila') ?>">
                        <?= form_error('permanent_upazila', '<div class="text-danger">', '</div>'); ?>
                    </div>
                    <label for="permanent_zila" class="col-sm-2 control-label">জেলা  </label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="permanent_zila" name="permanent_zila" placeholder="জেলা" value="<?= set_value('permanent_zila') ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="present_village" name="present_village" placeholder="গ্রাম/মহল্লা" value="<?= set_value('present_village') ?>">
                        <?= form_error('present_village', '<div class="text-danger">', '</div>'); ?>
                    </div>
                    <label for="present_post" class="col-sm-2 control-label">ডাকঘর  </label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="present_post" name="present_post" placeholder="ডাকঘর" value="<?= set_value('present_post') ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="present_upazila" name="present_upazila" placeholder="উপজেলা" value="<?= set_value('present_upazila') ?>">
                        <?= form_error('present_upazila', '<div class="text-danger">', '</div>'); ?>
                    </div>
                    <label for="present_zila" class="col-sm-2 control-label">জেলা  </label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="present_zila" name="present_zila" placeholder="জেলা" value="<?= set_value('present_zila') ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="phone" name="phone" placeholder="ফোন / মোবাইল নং" value="<?= set_value('phone') ?>" onChange="checkInput(this)" onKeyup="checkInput(this)">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="guardian_job" name="guardian_job" placeholder="অভিভাবকের পেশা" value="<?= set_value('guardian_job') ?>">
                        <?= form_error('guardian_job', '<div class="text-danger">', '</div>'); ?>
                    </div>
                    <label for="annual_income" class="col-sm-2 control-label">বার্ষিক আয়  </label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="annual_income" name="annual_income" placeholder="বার্ষিক আয়" value="<?= set_value('annual_income') ?>" onChange="checkInput(this)" onKeyup="checkInput(this)">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group date">
                            ...
                            <input type="date" class="form-control pull-right" id="dob" name="dob" value="<?= set_value('dob') ?>">
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <select name="blood_group" class="form-control" id="blood_group">
                            ...
                            <option <?= set_value('blood_group') == 'A+' ? 'selected':'' ?> value="A+">A+</option>
                            <option <?= set_value('blood_group') == 'O+' ? 'selected':'' ?> value="O+">O+</option>
                            <option <?= set_value('blood_group') == 'B+' ? 'selected':'' ?> value="B+">B+</option>
                            <option <?= set_value('blood_group') == 'AB+' ? 'selected':'' ?> value="AB+">AB+</option>
                            <option <?= set_value('blood_group') == 'A-' ? 'selected':'' ?> value="A-">A-</option>
                            <option <?= set_value('blood_group') == 'O-' ? 'selected':'' ?> value="O-">O-</option>
                            <option <?= set_value('blood_group') == 'B-' ? 'selected':'' ?> value="B-">B-</option>
                            <option <?= set_value('blood_group') == 'AB-' ? 'selected':'' ?> value="AB-">AB-</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="height" name="height" placeholder="উচ্চতা (মিটার)" value="<?= set_value('height') ?>" >
                    </div>
                    <label for="weight" class="col-sm-2 control-label">ওজন (কেজি) </label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="weight" name="weight" placeholder="ওজন (কেজি) " value="<?= set_value('weight') ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="identification_mark" class="col-sm-3 control-label">সনাক্তকরণ চিহ্ন (যদি থাকে)</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="identification_mark" name="identification_mark" placeholder="সনাক্তকরণ চিহ্ন (যদি থাকে)" value="<?= set_value('identification_mark') ?>" >
                    </div>
                    <label for="health_status" class="col-sm-2 control-label">স্বাস্থ্যগত অবস্থা</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="health_status" name="health_status" placeholder="স্বাস্থ্যগত অবস্থা" value="<?= set_value('health_status') ?>">
                    </div>
                </div>
            </div>
			-->
