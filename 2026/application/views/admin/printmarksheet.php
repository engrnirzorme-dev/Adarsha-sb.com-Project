...
<html lang="en">
    ...
    <head>
        ...
        <title>বিষয় ভিত্তিক পরীক্ষার ফলাফল - <?= toBangla(date("2026")) ?></title>
        ...
        foreach ($students as $row) {
            ...
            <div class="marksheet" style="color:black">
                <div class="head">
                    ...
                    <div class="title">
                        <h2>আদর্শ শিশু বিদ্যালয়, নেত্রকোণা</h2>
                        <h3>বিষয় ভিত্তিক পরীক্ষার ফলাফল - <?= to_bangla(date("2026")) ?></h3>
                    </div>
                    <table>
                        <tr>
                            <td>Letter Grade</td>
                ...
                <table class="student-info" style="width: 100%; margin: 7px 0">
                    <tr>
                        ...
                        <td>প্রাপ্ত পয়েন্ট/গ্রেড : <b><?= $show_4 ? toBangla($row->gpa).'/'.gla($row->gpa) : '' ?></b></td>
                    </tr>
                </table>
                <table>
                    <tbody>
                        <tr>
                            <td style="background: #25B7EF" rowspan="2"><div class="rotate">বিষয়</div></td>
                            <td rowspan="2" style="width: 132px; background: #25B7EF">মান বন্টন</td>
                            <td colspan="3" style="background: #25B7EF"><strong>প্রথম মূল্যায়ন</strong></td>
                            <td colspan="3" style="background: #25B7EF"><strong> দ্বিতীয় মূল্যায়ন </strong></td>
                            <td colspan="3" style="background: #25B7EF"><strong>চূড়ান্ত মূল্যায়ন </strong></td>
                ...
                <table class="student-info" style="width: 60%; margin: 8px auto 0">
                    <tr>
                ...
                <div class="signature">
                    <div class="left" style="text-align: center; min-width: 180px;">
                        <div style="height: 2px; background: #444; width: 100%; margin-bottom: 4px;"></div>
                        শ্রেণী শিক্ষকের &nbsp; স্বাক্ষর
                    </div>
                    <div class="right" style="text-align: center; min-width: 180px;">
                        <img src="<?= base_url('assets/website/img/signature.jpg') ?>" style="display: block; height: 55px; max-width: 160px; object-fit: contain; margin: 0 auto 3px auto;">
                        <div style="height: 2px; background: #444; width: 100%; margin-bottom: 4px;"></div>
                        ভারপ্রাপ্ত অধ্যক্ষের স্বাক্ষর
                    </div>
                </div>
            </div>
            <?php
